...
function bluez8_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['bluez_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs', 'bluez8'),
  ...
  $form['bluez_settings']['slideshow']['slideshow_display'] = array(
    ...
    '#default_value' => theme_get_setting('slideshow_display', 'bluez8'),
  ...
  $form['bluez_settings']['slideshow']['slide1']['slide1_title'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Title'),
    '#default_value' => theme_get_setting('slide1_title', 'bluez8'),
  );
  $form['bluez_settings']['slideshow']['slide1']['slide1_desc'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide1_desc', 'bluez8'),
  );
  ...
  $form['bluez_settings']['slideshow']['slide2']['slide2_title'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Title'),
    '#default_value' => theme_get_setting('slide2_title', 'bluez8'),
  );
  $form['bluez_settings']['slideshow']['slide2']['slide2_desc'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide2_desc', 'bluez8'),
  );
  ...
  $form['bluez_settings']['slideshow']['slide3']['slide3_title'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Title'),
    '#default_value' => theme_get_setting('slide3_title', 'bluez8'),
  );
  $form['bluez_settings']['slideshow']['slide3']['slide3_desc'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide3_desc', 'bluez8'),
  );
  ...
  $form['bluez_settings']['Welcome']['welcome_title'] = array(
    '#type' => 'textfield',
    '#title' => t('Add Title'),
    '#default_value' => theme_get_setting('welcome_title', 'bluez8'),
  ...
  $form['bluez_settings']['Welcome']['welcome_text'] = array(
    ...
    '#default_value' => theme_get_setting('welcome_text', 'bluez8'),
  ...
  $form['bluez_settings']['footer']['footer_copyright'] = array(
    ...
    '#default_value' => theme_get_setting('footer_copyright', 'bluez8'),
  ...
  $form['bluez_settings']['footer']['footer_developed'] = array(
    ...
    '#default_value' => theme_get_setting('footer_developed', 'bluez8'),
  ...
  $form['bluez_settings']['footer']['footer_developedby'] = array(
    ...
    '#default_value' => theme_get_setting('footer_developedby', 'bluez8'),
  ...
  $form['bluez_settings']['footer']['footer_developedby_url'] = array(
    ...
    '#default_value' => theme_get_setting('footer_developedby_url', 'bluez8'),
    '#description'   => t("Add url developed by in footer. example:: http://www.xyz.com"),
  );
  $form['bluez_settings']['menu'] =array(
    '#type' => 'fieldset',
    '#title' => t('Menu'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );
  $form['bluez_settings']['menu']['menu_name'] = array(
    '#type' => 'select',
    '#title' => t('Menu list'),
    '#options' => menu_ui_get_menus(),
    '#default_value' => theme_get_setting('menu_name', 'bluez8'),
